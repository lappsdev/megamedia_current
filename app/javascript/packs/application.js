...
Vue.use(ActionCableVue, {
  debug: true,
  debugLevel: 'error',
  connectionUrl: env == "development" ? 'ws://localhost:5000/cable' : 'wss://app.varejo4.tech/cable', // or function which returns a string with your JWT appended to your server URL as a query parameter
